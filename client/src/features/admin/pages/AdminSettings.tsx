...
// Define the Zod schema for admin creation
        ...
        <Table>
          ...
          <TableBody>
            {isPending ? (
              ...
              <TableRow>
                <TableCell colSpan={5}>
                  {(error as Error)?.message || "Failed to load administrators"}
                </TableCell>
              </TableRow>
            ) : adminUsers.length ? (
          ...
          <Form {...form}>
            ...
            >
              ...
              <DialogFooter className="mt-6">
                ...
                <Button className="" type="submit" disabled={createSubAdmin.isPending}>
