...
export default function RedemptionForm() {
  ...
  return (
    <OnboardingLayout
      pageTitle="Investor Funds Redemption"
      pageDescription="Please complete all details to request redemption of your invested funds."
    >
      <PageTransition>
        <FadeIn>
                ...
                <Form {...form}>
                  ...
                  >
                    ...
                    <section className="space-y-4">
                      <h3 className="font-semibold mt-4">Investment Details</h3>
